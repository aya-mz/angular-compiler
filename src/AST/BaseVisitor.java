...
public class BaseVisitor extends AngulerParserBaseVisitor {
    ...
    public ImportNode visitImporT(AngulerParser.ImporTContext ctx) {
        ...
        try{
            ...
            else if(!symbolTable.importDefinitionSymbolTable.isExist(importStatement.getImportedSymbolNode().getFirst().getMODULE_NAME().substring(1,importStatement.getImportedSymbolNode().getFirst().getMODULE_NAME().length()-2),importFrom.getSTRING_LITERAL()))
            ...
            ErrorLogger.log("UndefinitionImportException: "+e);
        }
        return importNode;
    }
    ...
    public ComponentNode visitComponent(AngulerParser.ComponentContext ctx) {
        ...
        try{
            ...
            ErrorLogger.log("MissingTemplateException: "+e);
        }
        return component;
    }
    ...
    public SelectorDataNode visitSelector_data(AngulerParser.Selector_dataContext ctx) {
        ...
        try{
            ...
            ErrorLogger.log("ComponentPropertyRedefinitionException: "+e);
        }
        return selectorData;
    }
    ...
    public ImportsDataNode visitImports_data(AngulerParser.Imports_dataContext ctx) {
        ...
        try{
            ...
            ErrorLogger.log("UnknownReferenceImportException: "+e);
        }
        try{
    ...
    public P_appNode visitP_app(AngulerParser.P_appContext ctx) {
        ...
        try{
            ...
            ErrorLogger.log("DuplicateStylePropertyException: "+e);
        }
        scopes.add(".app");
    ...
    public ClickNode visitClick(AngulerParser.ClickContext ctx) {
        ...
        if(assignedVariable!=null){
            try {
                ...
                ErrorLogger.log("UndeclaredIdentifierException: "+e);
            }
        }
        scopes.pop();
